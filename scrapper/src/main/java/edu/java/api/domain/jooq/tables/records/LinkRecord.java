...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
     ...
     */
    @ConstructorProperties({ "linkId", "url", "updatedAt", "checkedAt" })
    public LinkRecord(@Nullable Long linkId, @NotNull String url, @NotNull OffsetDateTime updatedAt, @NotNull OffsetDateTime checkedAt) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(edu.java.api.domain.jooq.tables.pojos.Link value) {
        super(Link.LINK);
